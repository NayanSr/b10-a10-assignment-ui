...
const VisaDetails = () => {
  ...
  const handleSubmit = (e) => {
    ...
    fetch('http://localhost:5000/myApplied',{
      method:'POST',
  ...
  return (
    <div className="mt-4">
      ...
      <br />
      <br />
      8. Visa details page: private/protected route. Please make sure that if
      the user is not logged in, the private route redirects to the login page.
      On this page, you will show all the information you have stored in the
      database about the visa. <br />● Add a “Apply for the visa” button on this
      page.Clicking the “Apply for the visa” button will open a modal where the
      logged in user can submit their information through a form.The form will
      have several input fields- <br />
      ...
      also this data will be shown on the “My visa applications” page (see
      requirement 10).
    </div>
  );
};
